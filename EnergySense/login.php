...
<p>Login to EnergySense:</p>
<form action="./form-action.php" method="post">
<div class="input-group">

<span class="input-group-addon" id="basic-addon1">Username:</span>
<input type="text" value="username" name="username" class="form-control" placeholder="" aria-describedby="basic-addon1">
</div>
</br>
<div class="input-group">

<span class="input-group-addon" id="basic-addon1">Password:</span>
<input type="password" value="password" name="password" class="form-control" placeholder="" aria-describedby="basic-addon1">
</div>
</br>
...
<button type="submit" value="SignUp" class="btn btn-danger btn-block">Sign up</button>
</form>
</div>
</div>
</div>
